...
DIFFICULTY_PRESETS: dict[DifficultyId, DifficultyDefinition] = {
    DIFFICULTY_EASY: DifficultyDefinition(
        ...
        enemy_count_scale=0.82,
        enemy_room_cap_bonus=-1,
        ambush_probability=0.38,
        boss_guard_probability=0.62,
        pickup_density_scale=1.35,
        damage_pressure_bias=0.82,
        safe_room_bias=1.18,
        target_pressure_min=0.9,
        target_pressure_max=1.45,
    ),
    ...
    DIFFICULTY_HARD: DifficultyDefinition(
        ...
        enemy_count_scale=1.24,
        enemy_room_cap_bonus=1,
        ambush_probability=0.88,
        boss_guard_probability=1.0,
        pickup_density_scale=0.62,
        damage_pressure_bias=1.26,
        safe_room_bias=0.74,
        target_pressure_min=2.2,
        target_pressure_max=3.2,
    ),
}
